  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          name="description"
          content="The Troubleshooting tips below can help you solve problems and answer questions you may have with your Beam remote control"
        />
      </Helmet>
      <h1
        style={{
          height: "100px",
          backgroundColor: "#A67EB1",
          fontSize: "250%",
          color: "white"
        }}
      >
              ...
              <Card style={{ marginLeft: "4%", marginRight: "4%" }}>
                <CardHeader style={{ backgroundColor: "white" }}>
                  <div style={styleDiv}>
                    <input
                      ...
                      id="toggler1"
                      alt="img-button"
                      onClick={e => btnToggler(e.target.id)}
                      onTouchStart={e => btnToggler(e.target.id)}
                    />
                ...
                <UncontrolledCollapse toggler="#toggler1">
                  <CardBody style={styleCardsBody}>
                    If you're using the app and having trouble programming your
              ...
              <Card style={{ marginLeft: "4%", marginRight: "4%" }}>
                <CardHeader style={{ backgroundColor: "white" }}>
                  <div style={styleDiv}>
                    ...
                    />
                    <h3 style={styleQuestions}>
                      Some of the buttons of the remote are not supported or
                ...
                <UncontrolledCollapse toggler="#toggler2">
                  <CardBody style={styleCardsBody}>
                    ...
                    compatible with your device. Try selecting the next code
                    from the options available for the category and brand of
                    your device. If you are unsuccessful at finding a better
                    matching code, it may be that there are some buttons from
                    your device's original remote that are not supported. You
                    can easily copy them using the <b>Custom Buttons</b> or{" "}
              ...
              <Card style={{ marginLeft: "4%", marginRight: "4%" }}>
                <CardHeader style={{ backgroundColor: "white" }}>
                  <div style={styleDiv}>
                    ...
                    />
                    <h3 style={styleQuestions}>
                      My device does not match any of the DEVICE CATEGORIES on
                      the remote
                    </h3>
                  </div>
                </CardHeader>
                <UncontrolledCollapse toggler="#toggler3">
                  <CardBody style={styleCardsBody}>
                    ...
                    anything else that is controlled by an IR remote and does
                    not fit one of the remote’s Device Category options, on the
                    app select <b>OTHER</b> and use <b>SMART SEARCH</b> to try
                    and find a matching code from our cloud database or copy all
                    the buttons of the original remote and store it under{" "}
                    <b>OTHER</b> in Device Categories of the remote.
                  </CardBody>
                </UncontrolledCollapse>
              </Card>
            </Fade>
              ...
              <Card style={{ marginLeft: "4%", marginRight: "4%" }}>
                <CardHeader style={{ backgroundColor: "white" }}>
                  <div style={styleDiv}>
                    ...
                    />
                    <h3 style={styleQuestions}>
                      The remote will not adjust the volume or channel on my
                      device
                    </h3>
                  </div>
                </CardHeader>
              ...
              <Card style={{ marginLeft: "4%", marginRight: "4%" }}>
                <CardHeader style={{ backgroundColor: "white" }}>
                  <div style={styleDiv}>
                    ...
                    />
                    <h3 style={styleQuestions}>
                      How do I know what Device Category or Activity mode the
                      remote is in?
                    </h3>
                  </div>
                </CardHeader>
                <UncontrolledCollapse toggler="#toggler6">
                  <CardBody style={styleCardsBody}>
                    When you press any button on the remote, the current Device
              ...
              <Card style={{ marginLeft: "4%", marginRight: "4%" }}>
                <CardHeader style={{ backgroundColor: "white" }}>
                  <div style={styleDiv}>
                    ...
                    />
                    <h3 style={styleQuestions}>
                      I copied a button from my original remote but it’s not
                      working
                    </h3>
                  </div>
                </CardHeader>
                <UncontrolledCollapse toggler="#toggler7">
                  <CardBody style={styleCardsBody}>
                    Beam is capable of copying any IR remote control button.
              ...
              <Card style={{ marginLeft: "4%", marginRight: "4%" }}>
                <CardHeader style={{ backgroundColor: "white" }}>
                  <div style={styleDiv}>
                    ...
                    />
                    <h3 style={styleQuestions}>
                      I can’t change the Activity settings on the app or on the
                      remote
                    </h3>
                  </div>
                </CardHeader>
                <UncontrolledCollapse toggler="#toggler8">
                  <CardBody style={styleCardsBody}>
                    To use the Activity buttons to control combo devices like
              ...
              <Card style={{ marginLeft: "4%", marginRight: "4%" }}>
                <CardHeader style={{ backgroundColor: "white" }}>
                  <div style={styleDiv}>
                    ...
                    />
                    <h3 style={styleQuestions}>
                      When I press the POWER button in Activity mode, some of my
                ...
                <UncontrolledCollapse toggler="#toggler9">
                  <CardBody style={styleCardsBody}>
                    For this feature to work, prior to pressing the POWER
                ...
                <CardHeader style={{ backgroundColor: "white" }}>
                  <div style={styleDiv}>
                    <input
                      ...
                      onTouchStart={e => btnToggler(e.target.id)}
                    />
                    <h3 style={styleQuestions}>I cannot find my remote</h3>
                  </div>
                </CardHeader>
                <UncontrolledCollapse toggler="#toggler11">
                  <CardBody style={styleCardsBody}>
                    Open the app and on the home screen press “FIND MY REMOTE”.
            ...
            <Card>
              <CardHeader>
                ...
                <h3 style={{ fontSize: "1.5rem" }}>
                  sjkdnfjknsjkdnfnsjkdnjkfnjskdnjfnsdf
                </h3>
              </CardHeader>
              <UncontrolledCollapse toggler="#toggler1">
                <CardBody>
...
<h1
      ...
      <UncontrolledCollapse toggler="#toggler2">
        <Card style={styleCards}>
          <CardBody style={styleCardsBody}>
            ...
            supported. You can easily copy them using the <b>Custom Buttons</b>{" "}
            or <b>Programming Manually</b> methods explained in this user guide.
          </CardBody>
        </Card>
      </UncontrolledCollapse>
      ...
      <UncontrolledCollapse toggler="#toggler3">
        <Card style={styleCards}>
          <CardBody style={styleCardsBody}>
            ...
            remote’s Device Category options, on the app select <b>OTHER</b> and
            use <b>SMART SEARCH</b> to try and find a matching code from our
            cloud database or copy all the buttons of the original remote and
            store it under <b>OTHER</b> in Device Categories of the remote.
          </CardBody>
        </Card>
      </UncontrolledCollapse>
      ...
      <UncontrolledCollapse toggler="#toggler4">
        <Card style={styleCards}>
          <CardBody style={styleCardsBody}>
            ...
            <b>Custom Buttons</b> or <b>Program Manually</b> method.
          </CardBody>
        </Card>
      </UncontrolledCollapse>
      ...
      <div style={styleDiv}>
        ...
        />
        <h3 style={styleQuestions}>
          When I press the POWER button in Activity mode, some of my devices do
      ...
      <div style={styleDiv}>
        <input
          ...
          onTouchStart={e => btnToggler(e.target.id)}
        />
        <h3 style={styleQuestions}>My remote isn’t working properly</h3>
      </div>
      <hr style={styleHr} />
      <UncontrolledCollapse toggler="#toggler10">
        <Card style={styleCards}>
