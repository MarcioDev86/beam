  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          name="description"
          content="Please use the code finder tool below to quickly find compatible codes for the different devices in your home. If there are several codes available for your device, test each one and select the code that is the most compatible with your device."
        />
      </Helmet>
          ...
          <Store>
            <Row>
              <Col>
                ...
                <p
                  style={{ width: "100%", marginTop: "2%", textAlign: "left" }}
                >
                  We suggest using the Beam app to program your remote. However,
                  if you would like to program the remote using the Code List,
                  please use the code finder tool below to quickly find
                  compatible codes for the different devices in your home. If
                  there are several codes available for your device, test each
                  one and select the code that is the most compatible with your
                  device.
                  <br />
                  <br />
